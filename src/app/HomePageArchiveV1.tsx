...
const marquee = "Story first. Systems that ship. ";

/** Preserved homepage (pre–executive/creator redesign). Used by /archive/home-v1. */
export function HomePageArchiveV1() {
  return (
    <div className={styles.page}>
      <main>
        <HomePortraitHero />

        <section className={styles.engine} aria-label="Growth highlights">
